...
class PolyClient:
        ...
        try:
            ...
            if api_key and api_secret and api_pass:
                ...
                self._clob = ClobClient(
                    ...
                    key=private_key,
                    creds=creds,
                    signature_type=0,  # EOA estándar — USDC.e aprobado
                )
                log.info("✅ ClobClient L2 listo (sig_type=0, USDC.e $499)")
    ...
    def _approve_clob_allowance(self):
        ...
        try:
            ...
            bal = self._clob.get_balance_allowance(params=BalanceAllowanceParams(asset_type=AssetType.COLLATERAL, signature_type=0))
